...
import 'package:tugas5/modules/home_screen/home_screen.dart';
import 'package:tugas5/modules/news_detail_screen/news_detail_screen.dart';
import 'package:tugas5/modules/splash_screen.dart/spalsh_screen.dart';
...
class AppRoutes {
  ...
  static Page _homeScreenBuilder(BuildContext context, GoRouterState state) {
    ...
    if (state.extra != null && state.extra is User) {
      ...
      user = User(
        id: 002,
        name: "Taufik Kurohman",
        username: "Taufik",
        email: "Cahaya@email.com",
        profilePhoto:
            "https://cms.dailysocial.id/wp-content/uploads/2022/10/fp7.jpg",
        phoneNumber: "081987654231",
      );
    }
    return MaterialPage(
      child: HomeScreen(
